...
class CustomDataset(torch.utils.data.Dataset):
    class_names = ('__background__',
                   'Bottle', 'Box', 'Bag', 'Can', 'Jar', 'Ampoule')
    ...
    def _get_annotation(self, image_id):
        annotation_file = os.path.join(self.data_dir, "labels", "%s.xml" % image_id)
    ...
    def get_img_info(self, index):
        ...
        annotation_file = os.path.join(self.data_dir, "labels", "%s.xml" % img_id)
